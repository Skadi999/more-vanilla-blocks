...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> OAK_WOOD_STAIRS = BLOCKS.register("oak_wood_stairs", () -> new StairsBlock(Blocks.OAK_WOOD::getDefaultState, AbstractBlock.Properties.from(Blocks.OAK_WOOD)));
    public static final RegistryObject<Block> SPRUCE_WOOD_STAIRS = BLOCKS.register("spruce_wood_stairs", () -> new StairsBlock(Blocks.SPRUCE_WOOD::getDefaultState, AbstractBlock.Properties.from(Blocks.SPRUCE_WOOD)));
    public static final RegistryObject<Block> BIRCH_WOOD_STAIRS = BLOCKS.register("birch_wood_stairs", () -> new StairsBlock(Blocks.BIRCH_WOOD::getDefaultState, AbstractBlock.Properties.from(Blocks.BIRCH_WOOD)));
    public static final RegistryObject<Block> ACACIA_WOOD_STAIRS = BLOCKS.register("acacia_wood_stairs", () -> new StairsBlock(Blocks.ACACIA_WOOD::getDefaultState, AbstractBlock.Properties.from(Blocks.ACACIA_WOOD)));
    public static final RegistryObject<Block> JUNGLE_WOOD_STAIRS = BLOCKS.register("jungle_wood_stairs", () -> new StairsBlock(Blocks.JUNGLE_WOOD::getDefaultState, AbstractBlock.Properties.from(Blocks.JUNGLE_WOOD)));
    public static final RegistryObject<Block> DARK_OAK_WOOD_STAIRS = BLOCKS.register("dark_oak_wood_stairs", () -> new StairsBlock(Blocks.DARK_OAK_WOOD::getDefaultState, AbstractBlock.Properties.from(Blocks.DARK_OAK_WOOD)));
    public static final RegistryObject<Block> CRIMSON_HYPHAE_STAIRS = BLOCKS.register("crimson_hyphae_stairs", () -> new StairsBlock(Blocks.field_235379_ms_::getDefaultState, AbstractBlock.Properties.from(Blocks.field_235379_ms_)));
    public static final RegistryObject<Block> WARPED_HYPHAE_STAIRS = BLOCKS.register("warped_hyphae_stairs", () -> new StairsBlock(Blocks.field_235370_mj_::getDefaultState, AbstractBlock.Properties.from(Blocks.field_235370_mj_)));
    public static final RegistryObject<Block> CRIMSON_STEM_STAIRS = BLOCKS.register("crimson_stem_stairs", () -> new StairsBlock(Blocks.field_235377_mq_::getDefaultState, AbstractBlock.Properties.from(Blocks.field_235377_mq_)));
    public static final RegistryObject<Block> WARPED_STEM_STAIRS = BLOCKS.register("warped_stem_stairs", () -> new StairsBlock(Blocks.field_235368_mh_::getDefaultState, AbstractBlock.Properties.from(Blocks.field_235368_mh_)));
    public static final RegistryObject<Block> OAK_LOG_STAIRS = BLOCKS.register("oak_log_stairs", () -> new StairsBlock(Blocks.OAK_WOOD::getDefaultState, AbstractBlock.Properties.from(Blocks.OAK_WOOD)));
    public static final RegistryObject<Block> SPRUCE_LOG_STAIRS = BLOCKS.register("spruce_log_stairs", () -> new StairsBlock(Blocks.SPRUCE_WOOD::getDefaultState, Block.Properties.from(Blocks.SPRUCE_WOOD)));
    public static final RegistryObject<Block> BIRCH_LOG_STAIRS = BLOCKS.register("birch_log_stairs", () -> new StairsBlock(Blocks.BIRCH_WOOD::getDefaultState, Block.Properties.from(Blocks.BIRCH_WOOD)));
    public static final RegistryObject<Block> ACACIA_LOG_STAIRS = BLOCKS.register("acacia_log_stairs", () -> new StairsBlock(Blocks.ACACIA_WOOD::getDefaultState, Block.Properties.from(Blocks.ACACIA_WOOD)));
    public static final RegistryObject<Block> JUNGLE_LOG_STAIRS = BLOCKS.register("jungle_log_stairs", () -> new StairsBlock(Blocks.JUNGLE_WOOD::getDefaultState, Block.Properties.from(Blocks.JUNGLE_WOOD)));
    public static final RegistryObject<Block> DARK_OAK_LOG_STAIRS = BLOCKS.register("dark_oak_log_stairs", () -> new StairsBlock(Blocks.DARK_OAK_WOOD::getDefaultState, Block.Properties.from(Blocks.DARK_OAK_WOOD)));
    ...
    public static final RegistryObject<Block> STRIPPED_OAK_LOG_STAIRS = BLOCKS.register("stripped_oak_log_stairs", () -> new StairsBlock(Blocks.STRIPPED_OAK_WOOD::getDefaultState, Block.Properties.from(Blocks.STRIPPED_OAK_WOOD)));
    public static final RegistryObject<Block> STRIPPED_SPRUCE_LOG_STAIRS = BLOCKS.register("stripped_spruce_log_stairs", () -> new StairsBlock(Blocks.STRIPPED_SPRUCE_WOOD::getDefaultState, Block.Properties.from(Blocks.STRIPPED_SPRUCE_WOOD)));
    public static final RegistryObject<Block> STRIPPED_BIRCH_LOG_STAIRS = BLOCKS.register("stripped_birch_log_stairs", () -> new StairsBlock(Blocks.STRIPPED_BIRCH_WOOD::getDefaultState, Block.Properties.from(Blocks.STRIPPED_BIRCH_WOOD)));
    public static final RegistryObject<Block> STRIPPED_JUNGLE_LOG_STAIRS = BLOCKS.register("stripped_jungle_log_stairs", () -> new StairsBlock(Blocks.STRIPPED_JUNGLE_WOOD::getDefaultState, Block.Properties.from(Blocks.STRIPPED_JUNGLE_WOOD)));
    public static final RegistryObject<Block> STRIPPED_ACACIA_LOG_STAIRS = BLOCKS.register("stripped_acacia_log_stairs", () -> new StairsBlock(Blocks.STRIPPED_ACACIA_WOOD::getDefaultState, Block.Properties.from(Blocks.STRIPPED_ACACIA_WOOD)));
    ...
    public static final RegistryObject<Block> OAK_LOG_SLAB = BLOCKS.register("oak_log_slab", () -> new SlabBlock(Block.Properties.from(Blocks.OAK_WOOD)));
    public static final RegistryObject<Block> SPRUCE_LOG_SLAB = BLOCKS.register("spruce_log_slab", () -> new SlabBlock(Block.Properties.from(Blocks.SPRUCE_WOOD)));
    public static final RegistryObject<Block> BIRCH_LOG_SLAB = BLOCKS.register("birch_log_slab", () -> new SlabBlock(Block.Properties.from(Blocks.BIRCH_WOOD)));
    public static final RegistryObject<Block> ACACIA_LOG_SLAB = BLOCKS.register("acacia_log_slab", () -> new SlabBlock(Block.Properties.from(Blocks.ACACIA_WOOD)));
    public static final RegistryObject<Block> JUNGLE_LOG_SLAB = BLOCKS.register("jungle_log_slab", () -> new SlabBlock(Block.Properties.from(Blocks.JUNGLE_WOOD)));
    public static final RegistryObject<Block> DARK_OAK_LOG_SLAB = BLOCKS.register("dark_oak_log_slab", () -> new SlabBlock(Block.Properties.from(Blocks.DARK_OAK_WOOD)));
    ...
    public static final RegistryObject<Block> STRIPPED_OAK_LOG_SLAB = BLOCKS.register("stripped_oak_log_slab", () -> new SlabBlock(Block.Properties.from(Blocks.STRIPPED_OAK_WOOD)));
    public static final RegistryObject<Block> STRIPPED_SPRUCE_LOG_SLAB = BLOCKS.register("stripped_spruce_log_slab", () -> new SlabBlock(Block.Properties.from(Blocks.STRIPPED_SPRUCE_WOOD)));
    public static final RegistryObject<Block> STRIPPED_BIRCH_LOG_SLAB = BLOCKS.register("stripped_birch_log_slab", () -> new SlabBlock(Block.Properties.from(Blocks.STRIPPED_BIRCH_WOOD)));
    public static final RegistryObject<Block> STRIPPED_JUNGLE_LOG_SLAB = BLOCKS.register("stripped_jungle_log_slab", () -> new SlabBlock(Block.Properties.from(Blocks.STRIPPED_JUNGLE_WOOD)));
    public static final RegistryObject<Block> STRIPPED_ACACIA_LOG_SLAB = BLOCKS.register("stripped_acacia_log_slab", () -> new SlabBlock(Block.Properties.from(Blocks.STRIPPED_ACACIA_WOOD)));
    public static final RegistryObject<Block> STRIPPED_DARK_OAK_LOG_SLAB = BLOCKS.register("stripped_dark_oak_log_slab", () -> new SlabBlock(Block.Properties.from(Blocks.STRIPPED_DARK_OAK_WOOD)));
    public static final RegistryObject<Block> OAK_WOOD_SLAB = BLOCKS.register("oak_wood_slab", () -> new SlabBlock(Block.Properties.from(Blocks.OAK_WOOD)));
    public static final RegistryObject<Block> SPRUCE_WOOD_SLAB = BLOCKS.register("spruce_wood_slab", () -> new SlabBlock(Block.Properties.from(Blocks.SPRUCE_WOOD)));
    public static final RegistryObject<Block> BIRCH_WOOD_SLAB = BLOCKS.register("birch_wood_slab", () -> new SlabBlock(Block.Properties.from(Blocks.BIRCH_WOOD)));
    public static final RegistryObject<Block> ACACIA_WOOD_SLAB = BLOCKS.register("acacia_wood_slab", () -> new SlabBlock(Block.Properties.from(Blocks.ACACIA_WOOD)));
    public static final RegistryObject<Block> JUNGLE_WOOD_SLAB = BLOCKS.register("jungle_wood_slab", () -> new SlabBlock(Block.Properties.from(Blocks.JUNGLE_WOOD)));
    public static final RegistryObject<Block> DARK_OAK_WOOD_SLAB = BLOCKS.register("dark_oak_wood_slab", () -> new SlabBlock(Block.Properties.from(Blocks.DARK_OAK_WOOD)));
    public static final RegistryObject<Block> CRIMSON_HYPHAE_SLAB = BLOCKS.register("crimson_hyphae_slab", () -> new SlabBlock(Block.Properties.from(Blocks.field_235379_ms_)));
    public static final RegistryObject<Block> WARPED_HYPHAE_SLAB = BLOCKS.register("warped_hyphae_slab", () -> new SlabBlock(Block.Properties.from(Blocks.field_235370_mj_)));
    public static final RegistryObject<Block> CRIMSON_STEM_SLAB = BLOCKS.register("crimson_stem_slab", () -> new SlabBlock(Block.Properties.from(Blocks.field_235377_mq_)));
    ...
    public static final RegistryObject<Block> PRISMARINE_BRICKS_WALL = BLOCKS.register("prismarine_bricks_wall", () -> new WallBlock(Block.Properties.from(Blocks.PRISMARINE_BRICKS)));
    public static final RegistryObject<Block> DARK_PRISMARINE_WALL = BLOCKS.register("dark_prismarine_wall", () -> new WallBlock(Block.Properties.from(Blocks.DARK_PRISMARINE)));
    public static final RegistryObject<Block> BASALT_WALL = BLOCKS.register("basalt_wall", () -> new WallBlock(Block.Properties.from(Blocks.field_235337_cO_)));
    public static final RegistryObject<Block> POLISHED_BASALT_WALL = BLOCKS.register("polished_basalt_wall", () -> new WallBlock(Block.Properties.from(Blocks.field_235338_cP_)));

    public static final RegistryObject<Block> OAK_WOOD_FENCE = BLOCKS.register("oak_wood_fence", () -> new FenceBlock(Block.Properties.from(Blocks.OAK_WOOD)));
    public static final RegistryObject<Block> BIRCH_WOOD_FENCE = BLOCKS.register("birch_wood_fence", () -> new FenceBlock(Block.Properties.from(Blocks.BIRCH_WOOD)));
    public static final RegistryObject<Block> SPRUCE_WOOD_FENCE = BLOCKS.register("spruce_wood_fence", () -> new FenceBlock(Block.Properties.from(Blocks.SPRUCE_WOOD)));
    public static final RegistryObject<Block> JUNGLE_WOOD_FENCE = BLOCKS.register("jungle_wood_fence", () -> new FenceBlock(Block.Properties.from(Blocks.JUNGLE_WOOD)));
    public static final RegistryObject<Block> ACACIA_WOOD_FENCE = BLOCKS.register("acacia_wood_fence", () -> new FenceBlock(Block.Properties.from(Blocks.ACACIA_WOOD)));
    public static final RegistryObject<Block> DARK_OAK_WOOD_FENCE = BLOCKS.register("dark_oak_wood_fence", () -> new FenceBlock(Block.Properties.from(Blocks.DARK_OAK_WOOD)));
    ...
    public static final RegistryObject<Block> STRIPPED_OAK_WOOD_FENCE = BLOCKS.register("stripped_oak_wood_fence", () -> new FenceBlock(Block.Properties.from(Blocks.STRIPPED_OAK_WOOD)));
    public static final RegistryObject<Block> STRIPPED_SPRUCE_WOOD_FENCE = BLOCKS.register("stripped_spruce_wood_fence", () -> new FenceBlock(Block.Properties.from(Blocks.STRIPPED_SPRUCE_WOOD)));
    public static final RegistryObject<Block> STRIPPED_BIRCH_WOOD_FENCE = BLOCKS.register("stripped_birch_wood_fence", () -> new FenceBlock(Block.Properties.from(Blocks.STRIPPED_BIRCH_WOOD)));
    public static final RegistryObject<Block> STRIPPED_ACACIA_WOOD_FENCE = BLOCKS.register("stripped_acacia_wood_fence", () -> new FenceBlock(Block.Properties.from(Blocks.STRIPPED_ACACIA_WOOD)));
    public static final RegistryObject<Block> STRIPPED_JUNGLE_WOOD_FENCE = BLOCKS.register("stripped_jungle_wood_fence", () -> new FenceBlock(Block.Properties.from(Blocks.STRIPPED_JUNGLE_WOOD)));
    public static final RegistryObject<Block> STRIPPED_DARK_OAK_WOOD_FENCE = BLOCKS.register("stripped_dark_oak_wood_fence", () -> new FenceBlock(Block.Properties.from(Blocks.STRIPPED_DARK_OAK_WOOD)));
